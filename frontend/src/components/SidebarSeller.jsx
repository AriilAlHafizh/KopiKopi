...
const Icons = {
  ...
  orders: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M3 3h18a1 1 0 011 1v2H2V4a1 1 0 011-1zm0 5h19v12a1 1 0 01-1 1H4a1 1 0 01-1-1V8zm5 4v2h8v-2H8z" />
    </svg>
  ),
  settings: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
export default function SidebarSeller({ onLogout }) {
  const navItems = [
    { name: "Dashboard", path: "/seller/dashboard", icon: Icons.dashboard },
    { name: "Produk Saya", path: "/seller/produk/ProdukList", icon: Icons.products },
    { name: "Pesanan", path: "/seller/pesanan", icon: Icons.orders },
    { name: "Pengaturan", path: "/seller/pengaturan", icon: Icons.settings },
  ];
